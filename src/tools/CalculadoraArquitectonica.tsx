  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        const loader: any = new Loader({ apiKey: MAPS_KEY, version: 'weekly' });
        const g: any = await loader.importLibrary('maps');
        const markerLib: any = await loader.importLibrary('marker');
        const geo: any = await loader.importLibrary('geocoding');
