...
export const CATALOG: CatalogTool[] = [
  ...
  { id: 'solicitud-permiso', code: '', label: 'Formulario de Solicitud de Permiso', folder: 4, sub: 'Expediente DOM', icon: 'FileText', estado: 'soon', tier: 'free', fases: ['TRÁMITE'], desc: 'Formulario de solicitud de permiso de edificación ante la DOM.' },
  ...
  { id: 'recepcion-final', code: '', label: 'Solicitud de Recepción Final', folder: 4, sub: 'Expediente DOM', icon: 'FileCheck', estado: 'soon', tier: 'free', fases: ['TRÁMITE'], desc: 'Solicitud de recepción definitiva de obras ante la DOM.' },
  /* b) Informes especiales */
  { id: 'accesibilidad', code: '', label: 'Accesibilidad Universal (DS 50)', folder: 4, sub: 'Informes especiales', icon: 'Accessibility', estado: 'soon', tier: 'free', fases: ['PROYECTO', 'TRÁMITE'], desc: 'Verificación de accesibilidad universal según DS 50.' },
  { id: 'informe-termico', code: '', label: 'Informe Norma Térmica NCh1973.Of2014', folder: 4, sub: 'Informes especiales', icon: 'Thermometer', estado: 'soon', tier: 'free', fases: ['TRÁMITE'], desc: 'Informe de cumplimiento de la norma térmica NCh1973.Of2014.' },
  ...
  { id: 'informe-suelo', code: '', label: 'Informe de Suelo', folder: 4, sub: 'Informes especiales', icon: 'Mountain', estado: 'soon', tier: 'free', fases: ['TRÁMITE'], desc: 'Informe de mecánica de suelos / estudio geotécnico.' },
  ...
  { id: 'eett-generales', code: '', label: 'EETT Generales', folder: 5, sub: 'EETT, Presupuesto y Carta Gantt', icon: 'ClipboardList', estado: 'soon', tier: 'free', fases: ['CONSTRUCCIÓN'], desc: 'Especificaciones técnicas generales (espera BD de EETT desde Excel).' },
  { id: 'eett-estructuras', code: '', label: 'EETT Estructuras', folder: 5, sub: 'EETT, Presupuesto y Carta Gantt', icon: 'ClipboardList', estado: 'soon', tier: 'free', fases: ['CONSTRUCCIÓN'], desc: 'Especificaciones técnicas de estructuras.' },
  { id: 'presupuesto', code: '', label: 'Presupuesto de Obras', folder: 5, sub: 'EETT, Presupuesto y Carta Gantt', icon: 'DollarSign', estado: 'soon', tier: 'free', fases: ['CONSTRUCCIÓN'], desc: 'Itemizado de obra (referencia 28 UF/m²).' },
  { id: 'gantt', code: '', label: 'Carta Gantt', folder: 5, sub: 'EETT, Presupuesto y Carta Gantt', icon: 'Calendar', estado: 'soon', tier: 'free', fases: ['CONSTRUCCIÓN'], desc: 'Ruta crítica y asignación de recursos a partidas.' },
  /* b) Seguimiento e ITO */
  ...
  { id: 'libro-obras', code: '', label: 'Libro de Obras Digital', folder: 5, sub: 'Seguimiento e ITO', icon: 'Notebook', estado: 'soon', tier: 'free', fases: ['CONSTRUCCIÓN'], desc: 'Libro de obras digital con anotaciones de inspección y respaldo.' },
  { id: 'rdi', code: '', label: 'Registro RDI (Requerimientos de Información)', folder: 5, sub: 'Seguimiento e ITO', icon: 'FileQuestion', estado: 'soon', tier: 'free', fases: ['CONSTRUCCIÓN'], desc: 'Registro y seguimiento de requerimientos de información (RDI).' },
